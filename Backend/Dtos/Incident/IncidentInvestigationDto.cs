...
namespace SafetyManagementPortal.Backend.DTOs.Incident
{
    public class IncidentInvestigationDto
    {
        ...
        public int IncidentObservationId { get; set; }    // Ensure model has this
        public int LeadInvestigatorId { get; set; }       // Ensure model has this
        public DateTime? TargetCompletionDate { get; set; }  // Ensure model has this
        public string InitialFindings { get; set; } = string.Empty;      // Ensure model has this
        public DateTime? CompletedDate { get; set; }      // Ensure model has this
    }
}
